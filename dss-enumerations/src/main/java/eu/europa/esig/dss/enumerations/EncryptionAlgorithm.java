...
public enum EncryptionAlgorithm implements OidBasedEnum {
	...
	/** COMPOSITES (hybrids) */
	ML_DSA_44_ECDSA_P256_SHA256("MLDSA44-ECDSA-P256-SHA256", "2.16.840.1.114027.80.9.1.3", "MLDSA44-ECDSA-P256-SHA256"),
	ML_DSA_65_ECDSA_P384_SHA512("MLDSA65-ECDSA-P384-SHA512", "2.16.840.1.114027.80.9.1.9", "MLDSA66-ECDSA-P384-SHA512"),
	ML_DSA_87_ECDSA_P384_SHA512("MLDSA87-ECDSA-P384-SHA512", "2.16.840.1.114027.80.9.1.12", "MLDSA87-ECDSA-P384-SHA512"),
	/** HMAC */
	HMAC("HMAC", "", "");
	...
	private boolean isCompositeFamily() {
		return ML_DSA_44_ECDSA_P256_SHA256 == this || ML_DSA_65_ECDSA_P384_SHA512 == this || ML_DSA_87_ECDSA_P384_SHA512 == this;
	}
